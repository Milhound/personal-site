...
function Privacy() {
  ...
  return (
    <div id="main-content" className="max-w-[860px] mx-auto my-8 px-4">
      <h1>Privacy Policy for Daniel Milholland</h1>

      <p>
        At Milhound, accessible from milhound.com, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and
        recorded by Milhound and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in Milhound. This
      ...
      <h2>Log Files</h2>
      <p>
        Milhound follows a standard procedure of using log files. These files log visitors when they
        visit websites. The information collected by log files include internet protocol (IP)
      ...
      <p>
        Like any other website, Milhound uses 'cookies'. These cookies are used to store information
      ...
      <p>
        Milhound does not knowingly collect any Personal Identifiable Information from children
